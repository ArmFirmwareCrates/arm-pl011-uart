...
mod tests {
    ...
    fn enable_230400_8n1() {
        ...
        let mut uart = uart_for_test(&mut regs);
    ...
    fn rx_fifo_empty() {
        let mut regs = FakePL011Registers::new();
        {
            let uart = uart_for_test(&mut regs);
